...
class SearchAPI(Enum):
    ...
    OPENALEX = "openalex"
    ACADEMIC = "academic"  # Semantic Scholar 优先，失败回退 OpenAlex
    # 可选网页补充（非主源）
    TAVILY = "tavily"
...
class Configuration(BaseModel):
    """Configuration for the Research Gap Discovery Agent."""
    ...
    search_api: SearchAPI = Field(
        ...
        title="Search API",
        description="Primary academic search backend (semantic_scholar/openalex/academic)",
    )
    ...
    openalex_mailto: Optional[str] = Field(
        default=None,
        title="OpenAlex Mailto",
        description="Contact email for OpenAlex polite pool",
    )
